...
const float brakemax = -800;    // comfortably pressing hard on load cell, with single cell, inverted is -400. To Stiffen brake go down to -800
const float arduino_vcc = 3.28; // G29 3.3v
...
const float dac_step = arduino_vcc / 1024; // Seeed DAC is only 10bit
